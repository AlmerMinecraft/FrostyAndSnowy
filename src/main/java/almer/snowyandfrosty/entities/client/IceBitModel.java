...
public class IceBitModel extends SinglePartEntityModel<IceBitEntity> {
    private final ModelPart bone;

    public IceBitModel(ModelPart root) {
    ...
    @Override
    public void setAngles(IceBitEntity windChargeEntity, float f, float g, float h, float i, float j) {
    }
    @Override
