...
public class SawmillScreenHandler extends ScreenHandler {
    ...
    public SawmillScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        super(FrostyAndSnowy.SAWMILL_SCREEN_HANDLER, syncId);
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(ModRecipeTypes.SAWMILLING, input, this.world);
        }
    ...
    void populateResult() {
        if (!this.availableRecipes.isEmpty() && this.isInBounds(this.selectedRecipe.get())) {
            RecipeEntry<SawmillRecipe> recipeEntry = (RecipeEntry)this.availableRecipes.get(this.selectedRecipe.get());
            ItemStack itemStack = ((SawmillRecipe)recipeEntry.value()).craft(this.input, this.world.getRegistryManager());
    ...
    public ScreenHandlerType<?> getType() {
        return FrostyAndSnowy.SAWMILL_SCREEN_HANDLER;
    }
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            } else if (this.world.getRecipeManager().getFirstMatch(ModRecipeTypes.SAWMILLING, new SimpleInventory(new ItemStack[]{itemStack2}), this.world).isPresent()) {
